...
Documentary::Documentary()
{
    ...
    Documentary::Documentary(unsigned new_id, unsigned new_haul_id, const char* new_title, float new_rate,
        ...
        : Movie(new_id, new_haul_id, new_title, new_rate,
            "Documentary", continuance, new_date, new_year, new_start, new_finish)
    {
    ...
    const char* Documentary::Theme() const {
        return theme;
    }
