...
Drama::Drama(unsigned new_id, unsigned new_haul_id, const MyString& new_title, float new_rate,
    ...
    : Movie(new_id, new_haul_id, new_title, new_rate, continuance,
        new_date, new_year, "Drama", new_start, new_finish)
{
